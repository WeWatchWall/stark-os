<template>
  <div class="page">
    <div class="toolbar">
      <span class="title">📝 Univer Docs</span>
...
const OPFS_FILENAME = 'univer-docs.json';
...
onMounted(async () => {
  ...
  const { UniverDocsCorePreset } = await import('@univerjs/presets/preset-docs-core');
  ...
  if (savedData) {
    univerAPI.createUniverDoc(savedData);
  } else {
