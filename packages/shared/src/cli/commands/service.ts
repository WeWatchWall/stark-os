  ...
  subcommands: [
    {
      ...
      options: [
        ...
        { flags: '-m, --mode <mode>', description: 'Scheduling mode: replica, daemon, or dynamic', defaultValue: 'replica' },
        { flags: '-r, --replicas <count>', description: 'Number of replicas (only for replica mode)', defaultValue: '1' },
